...
\title{Universidad de Costa Rica\\{\small Facultad de Ingenier\' ia\\Escuela de Ingenier\' ia El\' ectrica\\IE0521 – Estructuras de Computadoras II\\I ciclo 2015\\\vspace*{0.55in} Reporte 1}\\ Laboratorio 1: Multiplicador RTL \vspace*{1.35in}}
%\date{}  				
...
\include{ManejoProyecto}
\include{Diseno}
\include{EstrategiaPruebas}
